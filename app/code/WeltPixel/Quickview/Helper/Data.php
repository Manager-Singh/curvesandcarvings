...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function isEnabled() {
        return trim((string)($this->_quickviewOptions['general']['enable_product_listing'] ?? ''));
    }
    ...
    public function getCustomCSS() {
        return trim((string)($this->_quickviewOptions['general']['custom_css'] ?? ''));
    }
    ...
    public function getCloseSeconds() {
        return trim((string)($this->_quickviewOptions['general']['close_quickview'] ?? ''));
    }
